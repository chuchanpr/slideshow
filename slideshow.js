...
function slideShow() {
  ...
  function initializeSlideShowMarkup() {  
	...
	var slideWidthMax = "400"; //changed 18 Jun 2013
    //var slideHeightMax = maxSlideHeight(); // Returns a value that is always in pixel units.
	var slideHeightMax = "400";
  
    globals.wrapperObject.style.marginLeft="auto"; /*mine*/
	globals.wrapperObject.style.marginRight="auto"; /*mine*/
	globals.wrapperObject.style.position = "relative";
	globals.wrapperObject.style.position = "relative";
	//globals.wrapperObject.style.border =" solid 1px rgba(0,0,0,.1)";
   // globals.wrapperObject.style.overflow = "hidden"; // This is just a safety thing.
    ...
    for (var i = 0; i < slideCount; i++) { 
	  ...
	  globals.slideImages[i].style.borderRadius ="20px";
	  globals.slideImages[i].style.border = "solid 1px rgba(0,0,0,0.2)";
	  globals.slideImages[i].style.padding = "3px";
      //globals.slideImages[i].style.top = (slideHeightMax - globals.slideImages[i].getBoundingClientRect().height) / 2 + "px";   */ /*mine commented as no top padding was needed*/
	  globals.slideImages[i].style.width= "400px";
	  globals.slideImages[i].style.height ="400px";
  ...
  function maxSlideWidth() {
    ...
    for (var i = 0; i < slideCount; i++) {
      if (globals.slideImages[i].width > maxWidth) {
        //maxWidth = globals.slideImages[i].width; // The width of the widest slide so far. 18-Jun 2013
		maxWidth = "900";
